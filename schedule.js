...
var executeTask = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        FetchApi = function (url, method, data) { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, api[method]("".concat(url), {
                                data: data,
                            })];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error('Erro ao executar a tarefa:', error_1);
                        setTimeout(function () { return FetchApi(url, method); }, 30 * 60 * 1000);
                        return [3 /*break*/, 3];
